...
func runTests(t *testing.T, deferNewConnections bool) {
  t.Run("pool reuse", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             2,
      Dial:                d.dial,
      DeferNewConnections: deferNewConnections,
    }
  ...
  t.Run("max idle", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle: 2,
      Dial:    d.dial,
  ...
  t.Run("concurrent send receive", func(t *testing.T) {
    p := &redis.Pool{
  ...
  t.Run("borrow check", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             2,
      Dial:                d.dial,
  ...
  t.Run("monitor cleanup", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             2,
      MaxActive:           2,
  ...
  t.Run("pub sub cleanup", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             2,
      MaxActive:           2,
  ...
  t.Run("transaction cleanup", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             2,
      MaxActive:           2,
  ...
  t.Run("wait pool", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             1,
      MaxActive:           1,
  ...
  t.Run("wait pool close", func(t *testing.T) {
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             1,
      MaxActive:           1,
  ...
  t.Run("wait pool command error", func(t *testing.T) {
  ...
  t.Run("wait pool dial error", func(t *testing.T) {
    testErr := errors.New("test")
    d := poolDialer{t: t}
    p := &redis.Pool{
      MaxIdle:             1,
  ...
  t.Run("locking  TestOnBorrowFails pool doesnt crash", func(t *testing.T) {
    const count = 100
...
func TestPoolDeferred(t *testing.T) {
  runTests(t, true)
}

func runBenchmarkPoolGet(b *testing.B, p *redis.Pool) {
  b.StopTimer()
  c := p.Get()
...
func runBenchmarkPool(b *testing.B, deferNewConnections bool) {
  b.Run("pool get", func(b *testing.B) {
    p := redis.Pool{Dial: redis.DialDefaultServer, MaxIdle: 2, DeferNewConnections: deferNewConnections}
    runBenchmarkPoolGet(b, &p)
  })

  b.Run("pool get error", func(b *testing.B) {
    b.StopTimer()
    p := redis.Pool{Dial: redis.DialDefaultServer, MaxIdle: 2, DeferNewConnections: deferNewConnections}
    c := p.Get()
    if err := c.Err(); err != nil {
  ...
  b.Run("pool get ping", func(b *testing.B) {
    b.StopTimer()
    p := redis.Pool{Dial: redis.DialDefaultServer, MaxIdle: 2, DeferNewConnections: deferNewConnections}
    c := p.Get()
    if err := c.Err(); err != nil {
...
func BenchmarkPool(b *testing.B) {
  runBenchmarkPool(b, false)
}

func BenchmarkPoolDeferred(b *testing.B) {
  runBenchmarkPool(b, true)
}
